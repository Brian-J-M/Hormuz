...
- **LNG**: Today's count is 0 new transits. The *Mubaraz* (Apr 27–28) is a one-off event so far; no follow-on LNG transits confirmed for April 29. JKM spot LNG prices remain elevated. Stranded LNG carriers inside the Gulf: status unconfirmed but estimated at 17–19 (down from 19 if Mubaraz has cleared).
...
- **AIS caveat**: April 26 was fully AIS-visible (zero dark transits — an unusual positive data-quality event). April 27 had 1 dark outbound vessel. Mubaraz went AIS-silent after clearing the strait. Idemitsu Maru maintained AIS. Shadow-fleet crude activity in IRGC corridor continues; actual transit counts may marginally exceed confirmed figures.
